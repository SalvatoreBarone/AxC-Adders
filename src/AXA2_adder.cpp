 ...
 * @date   30 gen 2019
 * @brief  Implementation of AXA2 inexact hardware cell
 ******************************************************************************/

#include "inexact_adders_core.h"
#include "inexact_adders.h"

static bool AXA2_sum(const bool&, const bool&, const bool&);
static bool AXA2_carry(const bool&, const bool&, const bool&);

int inexact_adders::AXA2_adder(int nab, int first_operand, int second_operand, bool isSub)
{
...
static bool AXA2_sum(const bool &a, const bool &b, const bool &cin)
{
	if(	(0 == a && 0 == b && 0 == cin) ||
	   	(0 == a && 0 == b && 1 == cin) ||
	   	(1 == a && 1 == b && 0 == cin) ||
...
static bool AXA2_carry(const bool &a, const bool &b, const bool &cin)
{
	if(	(0 == a && 1 == b && 1 == cin) ||
	   	(1 == a && 0 == b && 1 == cin) ||
		(1 == a && 1 == b && 0 == cin)||
