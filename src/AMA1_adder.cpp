 ...
 * @date   30 gen 2019
 * @brief  Implementation of AMA1 inexact hardware cell
 ******************************************************************************/
...
static bool AMA1_sum(const bool &a, const bool &b, const bool &cin)
{
	if(	(0 == a && 0 == b && 1 == cin) ||
	   	(1 == a && 1 == b && 1 == cin) )
		return 1;
...
static bool AMA1_carry(const bool &a, const bool &b, const bool &cin)
{
	if(	(0 == a && 0 == b && 0 == cin) ||
	   	(0 == a && 0 == b && 1 == cin) ||
	   	(1 == a && 0 == b && 0 == cin) )
