 ...
 * @date   30 gen 2019
 * @brief  Implementation of AMA2 inexact hardware cell
 ******************************************************************************/
...
int inexact_adders::AMA2_adder(int nab, int first_operand, int second_operand, bool isSub )
{
...
static bool AMA2_sum(const bool &a, const bool &b, const bool &cin)
{
	if(	(0 == a && 0 == b && 0 == cin) ||
	   	(0 == a && 0 == b && 1 == cin) ||
		(0 == a && 1 == b && 0 == cin) ||
...
static bool AMA2_carry(const bool &a, const bool &b, const bool &cin)
{
	if(	(0 == a && 0 == b && 0 == cin) ||
	   	(0 == a && 0 == b && 1 == cin) ||
	   	(0 == a && 1 == b && 0 == cin) ||
