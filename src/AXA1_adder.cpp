 ...
 * @date   30 gen 2019
 * @brief  Implementation of AXA1 inexact hardware cell
 ******************************************************************************/
...
int inexact_adders::AXA1_adder(int nab, int first_operand, int second_operand, bool isSub )
{
...
static bool AXA1_sum(const bool &a, const bool &b, const bool &cin)
{
	return cin;	
}

static bool AXA1_carry(const bool &a, const bool &b, const bool &cin)
{
	if(	(0 == a && 0 == b && 0 == cin) ||
	   	(0 == a && 0 == b && 1 == cin) ||
	   	(0 == a && 1 == b && 1 == cin) ||
