...
{
    // inexact cell c_in=0
    BOOST_CHECK_EQUAL(AMA2_adder(1,0,0), 1);
    BOOST_CHECK_EQUAL(AMA2_adder(1,0,1), 1);
    BOOST_CHECK_EQUAL(AMA2_adder(1,1,0), 1);
    BOOST_CHECK_EQUAL(AMA2_adder(1,1,1), 2);

    // inexact cell c_in=1
    BOOST_CHECK_EQUAL(AMA2_adder(2,1,1), 2);
    BOOST_CHECK_EQUAL(AMA2_adder(2,1,3), 4);
    BOOST_CHECK_EQUAL(AMA2_adder(2,3,1), 4);
    BOOST_CHECK_EQUAL(AMA2_adder(2,3,3), 4);

}

BOOST_AUTO_TEST_CASE(AMA2_sys)
{
    BOOST_CHECK_EQUAL(AMA2_adder(3,18, 19), 37);
    BOOST_CHECK_EQUAL(AMA2_adder(4,43, 44), 87);
}