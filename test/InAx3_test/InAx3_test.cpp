...
{    
    // exact sum
    BOOST_CHECK_EQUAL(InAx3_adder(0,0,0,0), 0);
    BOOST_CHECK_EQUAL(InAx3_adder(0,0,1,0), 1);
    BOOST_CHECK_EQUAL(InAx3_adder(0,1,0,0), 1);
    BOOST_CHECK_EQUAL(InAx3_adder(0,1,1,0), 2);
...
{
    // inexact cell c_in=0
    BOOST_CHECK_EQUAL(InAx3_adder(1,0,0,0), 1);
    BOOST_CHECK_EQUAL(InAx3_adder(1,0,1,0), 1);
    BOOST_CHECK_EQUAL(InAx3_adder(1,1,0,0), 1);
    BOOST_CHECK_EQUAL(InAx3_adder(1,1,1,0), 2);

    // inexact cell c_in=1
    BOOST_CHECK_EQUAL(InAx3_adder(2,1,1,0), 2);
    BOOST_CHECK_EQUAL(InAx3_adder(2,1,3,0), 4);
    BOOST_CHECK_EQUAL(InAx3_adder(2,3,1,0), 4);
    BOOST_CHECK_EQUAL(InAx3_adder(2,3,3,0), 4);

}

BOOST_AUTO_TEST_CASE(InAx3_sys)
{
    BOOST_CHECK_EQUAL(InAx3_adder(4,35, 35,0), 76);
    BOOST_CHECK_EQUAL(InAx3_adder(3,21, 21,0), 42);
}