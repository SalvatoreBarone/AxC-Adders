...
{
    // inexact cell c_in=0
    BOOST_CHECK_EQUAL(AMA4_adder(1,0,0), 0);
    BOOST_CHECK_EQUAL(AMA4_adder(1,0,1), 0);
    BOOST_CHECK_EQUAL(AMA4_adder(1,1,0), 2);
    BOOST_CHECK_EQUAL(AMA4_adder(1,1,1), 2);

    // inexact cell c_in=1
    BOOST_CHECK_EQUAL(AMA4_adder(2,1,1), 2);
    BOOST_CHECK_EQUAL(AMA4_adder(2,1,3), 2);
    BOOST_CHECK_EQUAL(AMA4_adder(2,3,1), 4);
    BOOST_CHECK_EQUAL(AMA4_adder(2,3,3), 6);

}

BOOST_AUTO_TEST_CASE(AMA4_sys)
{
    BOOST_CHECK_EQUAL(AMA4_adder(3,19, 18), 38);
    BOOST_CHECK_EQUAL(AMA4_adder(3,23, 22), 46);
}