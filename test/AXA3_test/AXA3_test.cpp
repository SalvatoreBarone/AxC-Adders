...
{
    // inexact cell c_in=0
    BOOST_CHECK_EQUAL(AXA3_adder(1,0,0), 0);
    BOOST_CHECK_EQUAL(AXA3_adder(1,0,1), 0);
    BOOST_CHECK_EQUAL(AXA3_adder(1,1,0), 0);
    BOOST_CHECK_EQUAL(AXA3_adder(1,1,1), 2);

    // inexact cell c_in=1
    BOOST_CHECK_EQUAL(AXA3_adder(2,1,1), 2);
    BOOST_CHECK_EQUAL(AXA3_adder(2,1,3), 4);
    BOOST_CHECK_EQUAL(AXA3_adder(2,3,1), 4);
    BOOST_CHECK_EQUAL(AXA3_adder(2,3,3), 6);

}

BOOST_AUTO_TEST_CASE(AXA3_sys)
{
    BOOST_CHECK_EQUAL(AXA3_adder(4,38, 37), 72);
    BOOST_CHECK_EQUAL(AXA3_adder(5,171, 163), 326);
}